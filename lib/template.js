let template = {
  ...
  <body>
    ...
    friendList: function(friendName){
      return `
        <li>
    ...
    AddFriends: function (userInfo) {
      let list = '<ul class="friends" id="findFriends">';
      console.log("테스트:" + JSON.stringify(userInfo[0]));

      for (let i = 0; i < userInfo.length; i++) {
          if(userInfo[i].email == "검색 이메일" ){
              list += `
        <li>
